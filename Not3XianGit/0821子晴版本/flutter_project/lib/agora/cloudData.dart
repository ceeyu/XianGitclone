...
class CloudFile 
{
  ...
  CloudFile.fromJson(Map<String, dynamic> map): this
  (
...
class TestData 
{
  ...
  (
    "assets/cloudPicture/ic_cloud_add.svg",
  );
  static Widget iconImage = SvgPicture.asset
  (
    "assets/cloudPicture/ic_cloud_image.svg",
  );
  static Widget iconPdf = SvgPicture.asset
  (
    "assets/cloudPicture/ic_cloud_pdf.svg",
  );
  ...
  (
    "assets/cloudPicture/ic_cloud_video.svg",
  );
  static Widget iconLeave = SvgPicture.asset
  (
    "",
  );
}
